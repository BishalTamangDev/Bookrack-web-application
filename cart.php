            ...
            <div class="d-flex flex-row flex-wrap mt-3 gap-5 mb-2 pending-cart-status-div">
                <div class="pending-cart-status">
                    <div class="status-image-div">
                        <img class="status-image completed-status-image" src="assets/Icons/order-received.png" alt="">
                    </div>
                ...
                <div class="pending-cart-status">
                    <div class="status-image-div">
                        <img class="status-image completed-status-image" src="assets/Icons/order-confirmed.png" alt="">
                    </div>
                ...
                <div class="pending-cart-status">
                    <div class="status-image-div">
                        <img class="status-image completed-status-image" src="assets/Icons/order-picked.png" alt="">
                    </div>
                ...
                <div class="pending-cart-status">
                    <div class="status-image-div">
                        <img class="status-image completed-status-image" src="assets/Icons/order-arrived.png" alt="">
                    </div>
                ...
                <div class="pending-cart-status">
                    <div class="status-image-div">
                        <img class="status-image completed-status-image" src="assets/Icons/order-packed.png" alt="">
                    </div>
                ...
                <div class="pending-cart-status">
                    <div class="status-image-div">
                        <img class="status-image" src="assets/Icons/order-shipped.png" alt="">
                    </div>
                ...
                <div class="pending-cart-status">
                    <div class="status-image-div">
                        <img class="status-image" src="assets/Icons/order-Delivered.png" alt="">
                    </div>
                ...
                <div class="pending-cart-status">
                    <div class="status-image-div">
                        <img class="status-image" src="assets/Icons/order-Completed.png" alt="">
                    </div>
